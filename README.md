...
![Riff-Diff Screenshot](https://github.com/rohschinken/riff-diff/blob/main/assets/Riff-Diff_Screenshot_1.png?raw=true&v=1.1.0)
...
**[Windows (portable .exe)](https://github.com/rohschinken/riff-diff/releases/download/v1.1.0/riff-diff.exe)** — standalone desktop app, no installation needed. Requires Windows 10 1803+ or Windows 11 (WebView2).
